...
static std::set<OptionsPanel *> instances;

OptionsPanel::OptionsPanel(int x_, int y_, int w_, int h_)
...
#ifdef WIN32
  navigation = new Fl_Navigation(x()-1, y(), w()+2, h()+1);
#else
  navigation = new Fl_Navigation(x()-1, y()-1, w()+2, h()+1);
#endif
  {
...
void OptionsPanel::loadOptions(void)
{
  /* Compression */
...
void OptionsPanel::storeOptions(void)
{
  /* Compression */
...
void OptionsPanel::createCompressionPage(int tx, int ty, int tw, int th)
{
...
void OptionsPanel::createSecurityPage(int tx, int ty, int tw, int th)
{
#if defined(HAVE_GNUTLS) || defined(HAVE_NETTLE)
...
void OptionsPanel::createInputPage(int tx, int ty, int tw, int th)
{
...
void OptionsPanel::createShortcutsPage(int tx, int ty, int tw, int th)
{
...
void OptionsPanel::createDisplayPage(int tx, int ty, int tw, int th)
{
...
void OptionsPanel::createMiscPage(int tx, int ty, int tw, int th)
{
...
void OptionsPanel::handleAutoselect(Fl_Widget* /*widget*/, void *data)
{
  OptionsPanel *dialog = (OptionsPanel*)data;
...
void OptionsPanel::handleCompression(Fl_Widget* /*widget*/, void *data)
{
  OptionsPanel *dialog = (OptionsPanel*)data;
...
void OptionsPanel::handleX509(Fl_Widget* /*widget*/, void *data)
{
  OptionsPanel *dialog = (OptionsPanel*)data;
...
void OptionsPanel::handleRSAAES(Fl_Widget* /*widget*/, void *data)
{
  OptionsPanel *dialog = (OptionsPanel*)data;
...
void OptionsPanel::handleSystemKeys(Fl_Widget* /*widget*/, void* data)
{
#ifdef __APPLE__
  OptionsPanel* dialog = (OptionsPanel*)data;
...
void OptionsPanel::handleClipboard(Fl_Widget* /*widget*/, void *data)
{
  (void)data;
#if !defined(WIN32) && !defined(__APPLE__)
  OptionsPanel *dialog = (OptionsPanel*)data;
...
void OptionsPanel::handleModifier(Fl_Widget* /*widget*/, void *data)
{
  OptionsPanel *dialog = (OptionsPanel*)data;
  unsigned mask;
...
void OptionsPanel::handleFullScreenMode(Fl_Widget* /*widget*/, void *data)
{
  OptionsPanel *dialog = (OptionsPanel*)data;
...
int OptionsPanel::fltk_event_handler(int event)
{
  std::set<OptionsPanel *>::iterator iter;
...
void OptionsPanel::handleScreenConfigTimeout(void *data)
{
    OptionsPanel *self = (OptionsPanel *)data;
...
void OptionsPanel::handleAlwaysCursor(Fl_Widget* /*widget*/, void *data)
{
  OptionsPanel *dialog = (OptionsPanel*)data;
