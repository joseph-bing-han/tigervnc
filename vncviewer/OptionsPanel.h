...
/*
 * The connection options, extracted from the OptionsDialog window so that
 * they can be embedded in other dialogs as well.
 */
class OptionsPanel : public Fl_Group {
public:
  OptionsPanel(int x, int y, int w, int h);
  ~OptionsPanel() override;

  /* Refresh the widgets from the currently loaded parameters */
  void loadOptions(void);

  /* Write the widget values back to the parameters */
